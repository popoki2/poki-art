    ...
    <script>
        ...
        function renderShopItems() {
            ...
            items.forEach(item => {
                ...
                // ====================================================
                // [수정 완료] 원본 코드의 백틱 에러를 일반 문자열 결합(+)으로 변경
                // ====================================================
                ...
                card.innerHTML = '<div><div style="font-weight:bold; font-size:13px; color:#4a148c;">' + item.name + reqInfo + '</div></div>' + actionBtn;
        ...
        socket.on('updateRoomList', (roomList) => {
            ...
            roomList.forEach(r => {
                ...
                card.innerHTML = '<div style="font-weight:900; font-size:14px; display:flex; justify-content:space-between;">' +
